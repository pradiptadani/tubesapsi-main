<x-admin-layout>
    ...
    <div class="mx-auto max-w-screen-xl py-8">
        ...
        <div class="mx-auto w-full">
            <h1 class="text-2xl font-bold sm:text-3xl">Edit Lecture Account</h1>
        ...
        <form action="{{ route('admin.student.account.edit.process', ['account' > $user->id]) }}" method="post"
            ...
            <div class="w-full flex flex-col gap-y-4">
                ...
                <div class="w-full">
                    <label for="studentId" class="sr-only">Lecture Data</label>

                    <div class="relative">
                        <select name="lectureId" id="lectureId"
                            class="w-full rounded-lg border-gray-200 px-4 py-3 pe-12 text-sm shadow-sm">
                            <option value="{{ old('lectureId', $user->lectures->lectureId) }}" class="text-base">
