                    ...
                    <table class="min-w-full divide-y-2 divide-gray-200 bg-white text-sm">
                        <thead class="ltr:text-left rtl:text-right">
                            <tr>
                                ...
                                <th class="whitespace-nowrap px-4 py-2 font-medium text-gray-900">Recognition Course
                                </th>
                                <th class="whitespace-nowrap px-4 py-2 font-medium text-gray-900">Reason</th>
                                <th class="whitespace-nowrap px-4 py-2 font-medium text-gray-900">MBKM Activity
                                </th>
                            ...
                            @foreach ($recognitions as $recognition)
                                <tr class="text-center">
                                    ...
                                    <td class="whitespace-nowrap px-4 py-2 text-gray-700">
                                        <a
                                            href="{{ route('lecture.supervise.student.recognition.report', ['report' => $recognition->recognitionId]) }}">
                                            <button type="button"
